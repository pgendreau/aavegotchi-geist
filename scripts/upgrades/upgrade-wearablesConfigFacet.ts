  ...
  const facets: FacetsAndAddSelectors[] = [
    {
      ...
      addSelectors: [
        ...
        'function updateWearablesConfig(uint256 _tokenId, uint256 _wearablesConfigId, string _name, uint256[16] _wearablesToStore) external',
        'function getWearablesConfig(address _owner, uint256 _tokenId, uint256 _wearablesConfigId) external view',
        'function getWearablesConfigName(address _owner, uint256 _tokenId, uint256 _wearablesConfigId) external view',
        'function getWearablesConfigWearables(address _owner, uint256 _tokenId, uint256 _wearablesConfigId) external view',
        'function getAavegotchiWearablesConfigCount(address _owner, uint256 _tokenId) external view',
        'function isValidWearablesConfig(address _owner, uint256 _tokenId, uint256 _wearablesConfigId) external view',
      ],
      removeSelectors: [],
    },
  ];
